...
%  Modificado para LAN Pablo billeke 
...
try
    cfg.lan = evalin('base','cfg_lan_duneuro');
catch
    cfg.lan = 0; 
end
...
if cfg.lan == 1
   assignin('base', 'cfg_duneuro', cfg);
   errMsg = ['usaste opcion LAN 1 :)']
   return
end
if cfg.lan == 3
   cfg = evalin('base', 'cfg_duneuro');
   cfg.lan=3;
end
...
DuneuroExe = ['$HOME/.brainstorm/bst_duneuro/bin/bst_duneuro_meeg_mac64'];
errMsg = [''];
end
...
% Get temp folder
if cfg.lan == 0 || cfg.lan == 1   || cfg.lan == 4 
